...
gulp.task('structure:duplication', 'Detection for duplicate code. Default scr/ directory is checked.', ['composer:install'], function () {
  ...
  options: {
    source: 'The source files to check the php code duplication. To add multiple sources use a \',\'.Example gulp structure:duplication --source=Library/**/*.php,UnitTests/**/*.php'
  }
});
...
gulp.task('structure:complexity', 'Check the complexity of the code. Default scr/ directory is checked.', ['composer:install'], function() {
  ...
  options: {
    source: 'The source files to check the php code complexity. To add multiple sources use a \',\'.Example gulp structure:complexity --source=Library/,UnitTests/'
  }
});
